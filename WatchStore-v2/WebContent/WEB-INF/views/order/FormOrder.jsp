...
<div style="margin: 20px auto 20px; box-shadow: 0px 0px 10px 0px #888888; width: 800px;">
    <div style="display: flex; justify-content: space-between;">
        <div style="display: flex;">
            <div style="background: url(./resources/hinhAnh/c01-1.jpg) center/ cover no-repeat;
            width: 200px; height: 150px; margin-right: 20px;"></div>
            <div style="margin-top: 20px">
                <span style="margin-bottom: 10px; display: block;">${DatHang.getDongHo().getTenDongHo()}</span>
                <span>Số lượng: ${DatHang.getSoLuong()}</span>
            </div>
        </div>
        <div style="position: relative;">
            <span style="position: absolute;
                         top: 60px;
                         right: 20px;">
                         <fmt:formatNumber value="${DatHang.getDongHo().getGia() * DatHang.getSoLuong() }"
...
<div style="margin: 20px auto 20px; box-shadow: 0px 0px 10px 0px #888888; width: 800px;">
<h4 style="text-align:center; padding: 20px 0px">Nhập thông tin chi tiết</h4>
	<form action="/DongHoWeb/order/submit/${DatHang.getId()}.htm" >
		<div style="margin: 10px 10px 10px 10px;">
		<span style="line-height: 40px;">Họ tên người nhận</span>
		<input class="form-control form-control-sm" name="name" type="text" placeholder="" aria-label=".form-control-sm example">
		</div>
		<div style="margin: 10px 10px 10px 10px;">
		<span style="line-height: 40px;">Địa chỉ nhận</span>
		<input class="form-control form-control-sm" name="address" type="text" placeholder="" aria-label=".form-control-sm example">
		</div>
		<div style="margin: 10px 10px 10px 10px;">
		<span style="line-height: 40px;">Số điện thoại nhận</span>
		<input class="form-control form-control-sm" name="sdt" type="text" placeholder="" aria-label=".form-control-sm example">
		</div>
		<button type="submit" style="color: white; margin: 0px 0px 10px 10px" class="theme-button product-cart-button1">
											<span> <span class="cart-title">Cập nhật</span>
											</span>							</button>
	</form>
</div>
