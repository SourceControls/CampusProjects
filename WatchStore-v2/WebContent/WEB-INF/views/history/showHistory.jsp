													...
													<li class="menu-item-has-children"><a><s:message code="Languages"/></a>
														<ul class="common-class">
															<li class="sub-drop-add-class"><a
																href="/DongHoWeb/ShowHistory.htm?language=en">ENG</a></li>
															<li class="sub-drop-add-class"><a
																href="/DongHoWeb/ShowHistory.htm?language=vi">VN</a>
														</ul>
													</li>
												</ul>
											</nav>
...
<c:forEach items="${listDongHo1}" var="product">
		<div style="margin: 20px auto 20px; box-shadow: 0px 0px 10px 0px #888888; height: 150px; width: 800px;">
    <div style="display: flex; justify-content: space-between;">
    	  <div style="display: flex;">
                ...
                <span style="margin-bottom: 10px; display: block;">${product.getDongHo().getTenDongHo() }</span>
        ...
        <div style="position: relative;">
            <span style="position: absolute;
                         ...
                         right: -23px;
                         width: 150px;">
                         <fmt:formatNumber value="${product.getDonGia()}"
	...
	<span> <span style="position: absolute;
    				...
    				top: 24px;
    				width: 120px">
    				${product.getPhieuDat().getTrangThai() }
    		</span>
												</span>
		<div style="position: absolute;
    				...
    				width: 100px;
    				right: 482px;">
					<span>Số lượng: ${product.getSoLuong() }</span>
		</div>
        </div>
    </div>
</div>
