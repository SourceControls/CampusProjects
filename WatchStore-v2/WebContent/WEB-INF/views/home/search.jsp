						...
						<div class="container">
							...
							<div class="row">
								<div class="col-lg-12">
									...
									<div class="section-title mb-20" style = "padding-top: 30px">
										<h2>Kết quả tìm kiếm cho:<i>"${key}"</i> - ${fn:length(ListProduct)} kết quả!</h2>
									</div>
												...
												<div class="single-slider-product">
													<div class="single-slider-product__image">
														...
														<div class="single-slider-product__content">
															...
															<a href = "/DongHoWeb/search/addToCart/${cartID}/${w.idDongHo}.htm" id = "${idDongHo}">															
